...
function SelectTrigger({
  ...
  return (
    ...
    >
      {children}
      <SelectPrimitive.Icon render={<ChevronDownIcon className="shrink-0 in-aria-invalid:text-destructive/80 text-muted-foreground/80" size={16} />}></SelectPrimitive.Icon>
    </SelectPrimitive.Trigger>
  );
}
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        className={cn(
          ...
          position === "popper" &&
            "data-[side=left]:-translate-x-1 rtl:data-[side=left]:translate-x-1 data-[side=top]:-translate-y-1 w-full min-w-[var(--radix-select-trigger-width)] data-[side=right]:translate-x-1 rtl:data-[side=right]:-translate-x-1 data-[side=bottom]:translate-y-1",
          className,
        )}
